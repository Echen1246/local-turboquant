...
from research.benchmarks.niah import (
    build_niah_context,
    make_needle_spec,
    niah_system_prompt,
    niah_user_prompt,
...
from research.modeling.qwq import QwQLoadConfig, load_qwq_model
...
from research.runtime.kv_artifacts import (
    extract_layer_tensor_array,
    extract_layer_vectors,
    load_kv_artifact,
    tensor_map_layers,
)
from research.runtime.kv_capture import (
    model_config_summary,
    save_past_key_values,
    summarize_past_key_values,
)
from turboquant.runtime.generation import greedy_decode_with_prefill_cache, validate_generation_variant
from research.runtime.experiment_log import log_experiment_event
from research.runtime.metadata import ensure_dir, resolve_run_name, utc_timestamp, write_json
from research.runtime.query_capture import capture_query_projections, save_query_projections
...
def _run_niah_case_impl(
    ...
    generation = greedy_decode_with_prefill_cache(
        model=model,
        tokenizer=tokenizer,
        inputs=inputs,
    ...
    quantization_seconds = generation.metrics.quantization_seconds
    memory_metrics = {
        "prefill_cache": generation.metrics.prefill_cache,
        "turboquant_mse_packed_estimate": generation.metrics.turboquant_mse_packed_estimate,
        "turboquant_mse_packed_actual": generation.metrics.turboquant_mse_packed_actual,
        "post_cache_setup_gpu_memory": generation.metrics.post_cache_setup_gpu_memory,
        "gpu_peak_memory": generation.metrics.gpu_peak_memory,
    }
